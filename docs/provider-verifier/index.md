...
| `PACT_PROVIDER_VERSION` | Explicit provider version used by webhook verification; takes precedence over `GITHUB_SHA`                                                                                                                   | No                                       | --          |
| `PACT_PROVIDER_BRANCH`  | Explicit provider branch used by webhook verification; takes precedence over `GITHUB_BRANCH`                                                                                                                 | No                                       | --          |
| `PACT_CONSUMER_BRANCH`  | Adds an explicit consumer branch to the broker selectors                                                                                                                                                     | No                                       | --          |
